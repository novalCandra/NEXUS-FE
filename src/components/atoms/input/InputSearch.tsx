  ...
  return (
    <div className="relative flex flex-row">
      ...
      <input
        ...
        className="w-150 px-10 py-1 ring-2 ring-black focus:outline-none focus:ring-2 focus:ring-gray-700 rounded-md placeholder:text-gray-400 font-fredoka bg-white"
      />
