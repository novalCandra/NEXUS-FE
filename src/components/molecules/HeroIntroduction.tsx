...
export default function HeroIntroduction() {
    return (
        <>
            <div className="container min-h-screen md:h-150 flex flex-col px-1 md:flex-1 md:flex-row md:items-center md:justify-between min-w-full bg-paper md:px-10 lg:px-36 py-2 ring-4 ring-black space-x-3 md:space-x-10 lg:space-x-0">
                <div className="flex flex-col px-2 md:px-0 lg:px-2 py-10 md:py-0 w-96 md:w-100 lg:w-200 space-y-3">
                    <span className='text-xl font-fredoka'>One calm system</span>
                    <h2 className='text-5xl md:text-7xl lg:text-8xl font-fredoka font-semibold leading-14 md:leading-20'>Your thoughts deserve better than another tab.</h2>
                </div>
                <div className="flex flex-col md:flex-col lg:flex-row space-x-10 px-3 md:px-5 py-5 space-y-4 md:space-y-5 lg:space-y-10">
            ...
            <div className="container w-full h-70 md:h-80 min-w-full bg-black">
                <div className="flex flex-col space-y-4 px-0 py-4 items-center w-96 md:w-140 text-center mx-auto">
