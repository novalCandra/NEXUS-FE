...
export default function InputSearch(props: TypeComponentsInputSearch) {
  ...
  return (
    <div className="relative hidden md:flex flex-row">
      ...
      />
      <button type="button" className="absolute flex flex-row items-center gap-3 px-2 top-2.5 right-6 border-2 border-black rounded-md font-fredoka font-semibold">
