...
const CardInformasi = (props: TypeInfoString) => {
    ...
    return (
        <motion.div whileHover={{ scale: 1.02, transition: { duration: 0.2 } }} transition={{ duration: 0.4 }} className="bg-white w-85 md:w-72 lg:w-64 h-72 md:h-72 lg:h-96 flex flex-col border-2 px-4 py-5 space-y-9 md:space-y-5 border-black  rounded-md shadow-black-100 cursor-pointer justify-center relative">
